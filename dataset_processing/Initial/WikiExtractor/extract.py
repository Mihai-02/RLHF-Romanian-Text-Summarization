...
def compact(text, mark_headers=False):
    ...
    invalid_section = False                  ## ADAUGAT DE MINE
    invalid_section_titles = ["Legături externe", "Bibliografie", "Bibliografie suplimentară", "Lectură suplimentară", "Vezi și", "Referințe", "Note de completare", "Note"]
    ...
    for line in text.split('\n'):
        ...
        if m:
            ...
            if Extractor.HtmlFormatting:
                ...
                #title += '.'
               #title = "===" + title + "==="       #ADAUGAT DE MINE

            if lev <= 2:     
                if title in invalid_section_titles:                         ##ADAUGAT DE MINE
        ...
        if invalid_section:                                             ##ADAUGAT DE MINE
            continue
        ...
        # @see https://www.mediawiki.org/wiki/Help:Formatting
            ...
            else:                                                                                        ##ADAUGAT DE MINE  original: continue
                ch = line[0]
                page.append("   "+line.lstrip(ch))
                #page.append("   "+line.lstrip('*#;'))                                
        ...
        # Drop irrelevant lines
            ...
            if Extractor.keepSections:
                ...
                for (i, v) in items:
                    page.append("====="+v)                                          #MODIFICAT DE MINE     original:  page.append(v)     
            headers.clear()
